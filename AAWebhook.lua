...
-- Items Extract
for _, Module in next, game:GetService("ReplicatedStorage"):WaitForChild("src"):WaitForChild("Data"):WaitForChild("Items"):GetDescendants() do
...
-- World Extract
local Worlds = {}
for _, Module in next, game:GetService("ReplicatedStorage"):WaitForChild("src"):WaitForChild("Data"):WaitForChild("Worlds"):GetDescendants() do
    if Module:IsA("ModuleScript") then
...
function webhook()
    ...
    if game.PlaceId ~= 8304191830 then
        ...
        result = ResultHolder.Title.Text else levelname, result = "nil","nil" 
    end
        ...
        ["embeds"] = {
            {
                ...
                ["fields"] = {
                    {
                        ["name"] = "Player",
                        ["value"] = "Name: ||".. player.Name .. " (".. player.displayName ..")||\n".. outputLevel .."\n\n**Stats**\n".. total_stats_result .. "",
                        ["inline"] = true,
                    },
                    {
                        ["name"] = "Match",
